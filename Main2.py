...
def ecms():
    list = ["Pod1ecms_token.json", "Pod2ecms_token.json", "Pod3ecms_token.json", "Pod4ecms_token.json",
            ...
            "Pod9ecms_token.json", "Pod10ecms_token.json", "Pod11ecms_token.json", "Pod12ecms_token.json",
            "Pod13ecms_token.json"]
    otplist = {}
    ...
    for mail in list:
        ...
        if not creds or not creds.valid:
            if creds and creds.expired and creds.refresh_token:
                ...
                elif mail == "Pod8ecms_token.json":
                    credfile = "Pod8ecms.json"
                elif mail == "Pod9ecms_token.json":
                    credfile = "Pod9ecms.json"
                elif mail == "Pod10ecms_token.json":
                    credfile = "Pod10ecms.json"
                elif mail == "Pod11ecms_token.json":
                    credfile = "Pod11ecms.json"
                elif mail == "Pod12ecms_token.json":
                    credfile = "Pod12ecms.json"
                else:
                    credfile = "Pod13ecms.json"
        ...
        try:
            ...
            if mail == "Pod1ecms_token.json":
                ...
                userId = 'pod9ecms@gmail.com'
            elif mail == "Pod10ecms_token.json":
                userId = 'pod10ecms@gmail.com'
            elif mail == "Pod11ecms_token.json":
                userId = 'pod11ecms@gmail.com'
            elif mail == "Pod12ecms_token.json":
                userId = 'pod12ecms@gmail.com'
            else:
                userId = 'pod13ecms@gmail.com'
